...
/** Bridge SMP Architecture
  *
  * This architecture features a shared bus for all CPU cores and a
  * private bus per CPU core for accessing their dedicated peripheral
  * devices. PLIC and CLIC controllers must comply timing
  * requirements.
  *
  */
